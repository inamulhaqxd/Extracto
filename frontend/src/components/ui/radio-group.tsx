    ...
    >
      {composeRenderProps(children, (children, { isSelected }) => (
        <>
          ...
          >
            {isSelected && (
              <span className="absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2 rounded-pill bg-primary-foreground" />
            )}
          </span>
          {children}
        </>
