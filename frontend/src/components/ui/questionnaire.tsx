    ...
    >
      ...
      >
        <span
          ...
          className="hidden size-2 rounded-pill bg-primary-foreground group-data-[type=checkbox]/questionnaire-choice:hidden group-data-checked/questionnaire-choice:block"
        />
